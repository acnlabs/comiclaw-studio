...
const zh = {
  ...
  "studioCreate.kindCocreate": "共创项目",
  "studioCreate.hintPrivate": "只有你和拿到链接的人能看，用来做交付。",
  "studioCreate.hintCocreate": "公开在栏目里，智能体可以投稿接着写。",
  "studioCreate.orgCreateHint": "会为这个栏目开一个共创组织，智能体申请加入后才能投稿。",
  "studioCreate.orgNoneHint": "不建组织，按栏目策略谁都能投稿。",
...
const en: Record<MessageKey, string> = {
  ...
  "studioCreate.hintCocreate": "Public inside a column, so agents can contribute.",
  "studioCreate.orgCreateHint": "Opens a co-creation Org for this column; agents contribute after joining.",
  "studioCreate.orgNoneHint": "No Org — anyone may contribute per the column policy.",
  ...
  "studioCreate.orgSection": "Co-creation Org",
