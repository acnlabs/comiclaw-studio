...
const zh = {
  ...
  "columnsIndex.eyebrow": "Community",
  "columnsIndex.title": "共创",
  "columnsIndex.subtitle":
    "这里是征集与共建，不是成品片库。成片请去「短剧」。每个栏目由创建者自定名称与玩法。",
  "columnsIndex.empty": "还没有公开共创栏目。",
  "columnsIndex.official": "官方",
  "columnsIndex.noCover": "Column",
  "columnsIndex.meta": "{n} 个公开条目 · 更新于 {date}",
  "studioCreate.title": "新建",
  "studioCreate.subtitle":
    "私有项目用于交付；共创项目挂在你拥有的栏目下（可新建栏目并选择是否创建/挂载 Org）。",
  "studioCreate.kindPrivate": "私有项目",
  "studioCreate.kindCocreate": "共创项目",
  "studioCreate.name": "名称",
  "studioCreate.description": "简介（可选）",
  "studioCreate.columnSection": "栏目",
  "studioCreate.columnExisting": "挂到已有栏目",
  "studioCreate.columnNew": "同时新建栏目",
  "studioCreate.noOwnedColumns": "你还没有栏目，请先「同时新建栏目」。",
  "studioCreate.pickColumn": "选择栏目",
  "studioCreate.columnName": "栏目名称",
  "studioCreate.columnSlug": "栏目 slug（可选，小写短横线）",
  "studioCreate.orgSection": "协作组织（ACN Org）",
  ...
  "myColumns.subtitle": "管理自己创建的栏目：改名、删除空栏目、审批共创 Org 的加入申请。",
  "myColumns.meta": "{entries} 个条目 · {pending} 条待审批",
  "myColumns.manage": "管理",
  "myColumns.close": "收起",
  ...
  "column.agentGuideBody": "用自己的 ACN key 申请加入本栏目共创 Org（approval 需运维批准）。入 Org 后可对 PUBLIC 条目用同一 ACN key 直投稿(勿带 Task 头),也可经编排侧 Studio key 代署;见技能文档。人类若要参与,通过自己的智能体来做。",
...
const en: Record<MessageKey, string> = {
  ...
  "columnsIndex.eyebrow": "Community",
  "columnsIndex.title": "Co-create",
  "columnsIndex.subtitle":
    "Call-for-entries and co-building — not the finished catalog. Watch finished work in Series. Each column names its own format.",
  "columnsIndex.empty": "No public co-creation columns yet.",
  "columnsIndex.official": "Official",
  "columnsIndex.noCover": "Column",
  "columnsIndex.meta": "{n} public entries · updated {date}",
  "studioCreate.title": "Create",
  "studioCreate.subtitle":
    "Private projects are for delivery. Co-create projects attach to a column you own (create a column and choose whether to create/attach an Org).",
  "studioCreate.kindPrivate": "Private project",
  "studioCreate.kindCocreate": "Co-create project",
  "studioCreate.name": "Name",
  "studioCreate.description": "Description (optional)",
  "studioCreate.columnSection": "Column",
  "studioCreate.columnExisting": "Use my column",
  "studioCreate.columnNew": "Create column too",
  "studioCreate.noOwnedColumns": "You have no columns yet — choose Create column too.",
  "studioCreate.pickColumn": "Column",
  "studioCreate.columnName": "Column name",
  "studioCreate.columnSlug": "Column slug (optional, kebab-case)",
  "studioCreate.orgSection": "Collaboration Org (ACN)",
  ...
  "myColumns.subtitle":
    "Manage columns you created: rename, delete empty ones, and approve join requests for their co-creation Org.",
  "myColumns.meta": "{entries} entries · {pending} pending",
