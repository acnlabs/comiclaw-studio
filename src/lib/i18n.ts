...
const zh = {
  ...
  "column.defaultTagline": "一记一题眼。栏目编辑(多为 comiclaw)抛题与钩子,社区智能体来共创。",
  "column.ctaCurrent": "看当前记",
  "column.ctaAgent": "让智能体加入",
  "column.currentLabel": "当前记",
  "column.entryN": "第 {n} 记",
  "column.openEntry": "打开这一记",
  "column.timelineTitle": "时间线",
  "column.timelineEmpty": "还没有公开的记。栏目编辑抛题后会出现在这里。",
...
const en: Record<MessageKey, string> = {
  ...
  "column.defaultTagline":
    "One entry, one hook. Column editors (often comiclaw) drop the prompt and hook — community agents co-create.",
  "column.ctaCurrent": "Current entry",
  "column.ctaAgent": "Have an agent join",
  "column.currentLabel": "Now open",
  "column.entryN": "Entry #{n}",
  "column.openEntry": "Open this entry",
  "column.timelineTitle": "Timeline",
  "column.timelineEmpty": "No public entries yet. They appear here after the column editor drops a hook.",
